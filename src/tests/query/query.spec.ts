...
describe('Query Type', () => {
    ...
    test('should return and logical comparator structure', () => {
        ...
        expect(andLogicalQuery.left.kind).toEqual('equal');
        expect(andLogicalQuery.right.kind).toEqual('greater');
    });
    ...
    test('should return or logical comparator structure', () => {
        ...
        expect(orLogicalQuery.left.kind).toEqual('less');
        expect(orLogicalQuery.right.kind).toEqual('greater');
    });
});
